...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.wi4solutions.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.wi4solutions.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(com.wi4solutions.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.wi4solutions.domain.Authority.class.getName(), jcacheConfiguration);
